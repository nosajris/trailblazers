...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/api" | "/api/health" | "/api/newsletter" | "/api/reset" | "/api/seed" | "/bep-hub" | "/connect" | "/contact" | "/demo" | "/demo/lucia" | "/demo/lucia/login" | "/events" | "/events/[id]" | "/events/[id]/ics" | "/faq" | "/give" | "/groups" | "/messages" | "/plan-a-visit" | "/robots.txt" | "/serve" | "/sitemap.xml" | "/stories" | "/stories/[id]" | "/watch";
		RouteParams(): {
			"/events/[id]": { id: string };
		...
		Pathname(): "/" | "/api/health" | "/api/newsletter" | "/api/reset" | "/api/seed" | "/bep-hub" | "/connect" | "/contact" | "/demo" | "/demo/lucia" | "/demo/lucia/login" | "/events" | `/events/${string}` & {} | `/events/${string}/ics` & {} | "/faq" | "/give" | "/groups" | "/messages" | "/plan-a-visit" | "/robots.txt" | "/serve" | "/sitemap.xml" | "/stories" | `/stories/${string}` & {} | "/watch";
